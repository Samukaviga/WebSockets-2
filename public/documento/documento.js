...
function tratarAutorizacaoSucesso(payLoadToken){  //uma forma de enviar o payloadtoken do arquivo de socket-front-documento para documento js

  selecionarDocumento({ nomeDocumento, nomeUsuario: payLoadToken.nomeUsuario }); //enviando o nome do documento mais o payloadToken que seria o nome do usuario que esta no Token
